...
This document classifies all current integration tests by their owning crate
to guide the test move implementation in
`build-time-move-model-and-svg-tests.md`.

...
Invalid grouped-history boundaries are rejected atomically, so failed grouped
undo/redo interactions do not partially commit document changes or history
entries.

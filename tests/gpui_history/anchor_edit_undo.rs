...
fn draw_two_point_path(
    ...
    let p2 = point(
        bounds.origin.x + bounds.size.width - px(crate::common::CANVAS_PADDING_PX),
        bounds.origin.y + bounds.size.height - px(crate::common::CANVAS_PADDING_PX),
    );
...
fn assert_undo_redo_round_trip(
    ...
    crate::common::simulate_document_redo(visual_cx);
    read_shape_with_counts(
        visual_cx,
        view,
        PathCounts {

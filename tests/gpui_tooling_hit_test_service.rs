...
#[scenario(
    path = "tests/features/tooling_hit_test_service.feature",
    name = "Hovering a handle prefers the handle hit",
...
#[scenario(
    path = "tests/features/tooling_hit_test_service.feature",
    name = "The hover hit clears when the cursor moves to empty space",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_hit_test_service.feature",
    name = "The hover hit clears when leaving manipulate mode",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_hit_test_service.feature",
    name = "Clicking overlapping shapes selects the topmost shape",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]

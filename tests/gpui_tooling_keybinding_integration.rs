...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "UI initialization registers action bindings",
...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "Select all selects every shape",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "Deselect all clears the selection",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "Activating the pen tool switches to draw mode",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "Activating the select tool switches to manipulate mode",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "Activating the select tool clears the active draw shape",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "Tab toggles the edge mode in draw mode",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
...
#[scenario(
    path = "tests/features/tooling_keybinding_integration.feature",
    name = "Tab does not toggle the draw edge mode in manipulate mode",
    harness = rstest_bdd_harness_gpui::GpuiHarness,
)]
#[serial]
